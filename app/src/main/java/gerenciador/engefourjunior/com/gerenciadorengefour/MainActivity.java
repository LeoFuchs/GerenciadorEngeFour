...
public class MainActivity extends AppCompatActivity {
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(final Cursor item);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id== R.id.nova_venda) {
            ...
            if(clienteRepository.SelecionarTodos().size() != 0 && produtoRepository.SelecionarTodos().size() != 0) {
                startActivity(new Intent(this, NovaVenda.class));
                finish();
            }
            else
            {
                Alerta.Alert(this, this.getString(R.string.alerta_venda));
            }
        }
        else if (id== R.id.novo_cliente){
                startActivity(new Intent(this,NovoCliente.class));
                finish();
        }
        else if (id== R.id.novo_produto){
                startActivity(new Intent(this,NovoProduto.class));
                finish();
        }
